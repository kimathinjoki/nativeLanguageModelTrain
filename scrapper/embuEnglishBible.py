...
BIBLE_BOOKS = [
    ("GEN", "Genesis", 50),      # Genesis
    ("EXO", "Exodus", 40),       # Exodus
    ("LEV", "Leviticus", 27),    # Leviticus
...
def scrape_bible_text(url):
    ...
    # Get chapter title from h1 (like "Genesis 1")
    chapter_title = None
    ...
    # Find all verse elements using the consistent class pattern for NIV Bible
...
def main():
    ...
    output_file = os.path.join(output_dir, f"English_NIV_Bible.docx")
    ...
    # Starting URL (Genesis 1 in NIV Bible)
    ...
    print("\nStarting to scrape the NIV Bible into a single DOCX document...\n")
    ...
    try:
        ...
        print(f"\nDone! NIV Bible with {chapters_scraped} chapters saved to:")
        print(f"{output_file}")
